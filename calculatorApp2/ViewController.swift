...
//  calculatorApp2
//
//  Created by Yotaro Ito on 2021/04/16.
//
...
class ViewController: UIViewController {
    ...
    private func setUpNumberPad(){
        ...
        for x in 0..<5 {
            ...
            button4.setTitle(oparations[x], for: .normal)
            holder.addSubview(button4)
            button4.tag = x+1
            button4.addTarget(self, action: #selector(oparationPressed(_:)), for: .touchUpInside)
        }
...
//        -1をするのは0がないから
    ...
    @objc func oparationPressed(_ sender: UIButton){
//        タグをボタンに付与する
//        -1をするのは0がないから
        let tag = sender.tag
